...
//is not accessed in anyway if there is no agent-login session.  
    ...
    <div id="content">
        ...
        <header id="header">
            ...
            <div class="d-flex align-items-center">
                <div class="text-secondary me-3 d-none d-sm-block">Agent Dashboard</div>
                ...
                <div class="dropdown avatar-dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item" href="edit-profile.php"><i class="fas fa-user-edit"></i> Edit Profile</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="agent-logout.php"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
                    </ul>
                </div>
            </div>
        </header>
